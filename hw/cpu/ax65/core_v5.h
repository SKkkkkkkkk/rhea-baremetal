...
#define MNCAUSE_NMI_CAUSE    	0x7FFFFFFFFFFFFFFFUL
#else
#define MCAUSE_INT          	0x80000000UL
#define MCAUSE_CAUSE        	0x7FFFFFFFUL
#define MNCAUSE_NMI_CAUSE    	0x7FFFFFFFUL
#endif
...
#define MIP_LCOFI            	(1 << IRQ_LCOFI)
#define MIP_IMECCI          	(1 << IRQ_IMECCI)
