...
void config_mmu(void)
{
	...
	tt_l1[1] = TT_S1_NORMAL_WBWA | TT_S1_OUTER_SHARED | 0x40000000; // [0x40000000, 0x80000000) // NORMAL_WBWA, OUTER_SHARED, RW
	tt_l1[2] = TT_S1_NORMAL_WBWA | TT_S1_OUTER_SHARED | 0x80000000; // [0x80000000, 0xC0000000) // NORMAL_WBWA, OUTER_SHARED, RW
	tt_l1[3] = TT_S1_NORMAL_WBWA | TT_S1_OUTER_SHARED | 0xC0000000; // [0xC0000000, 0x100000000) // NORMAL_WBWA, OUTER_SHARED, RW
